...
{
%>
<h3 class="alert"> Order Successfully Delivered!</h3>
<%} %>
...
<table id="customers">
        ...
        try
        {
        	...
        	ResultSet rs=st.executeQuery("select * from cart inner join product where cart.productid=product.id and cart.orderDate is not NULL and cart.status='processing'" );
        	while(rs.next())
        	{
