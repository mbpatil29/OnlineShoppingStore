...
%>
        ...
        <tbody>
         <%                                                                     
      ResultSet rs=st.executeQuery("select * from product inner join cart on product.id=cart.productid and cart.email='"+email+"' and cart.address is NULL");
  	while(rs.next())
  	{
      %>
          <tr>
...
<h3>Select way of Payment</h3>
 ...
 <option value="Online Method">Online Payment</option>
 </select>

</div>

<div class="right-div">
<h3>Pay online on this Phonepe@pay.com</h3>
