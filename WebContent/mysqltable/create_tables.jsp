...
try
{
	//Database created with name groceryonline
	
	Connection con=ConnectionProvider.getCon();
	Statement st=con.createStatement();
	String q1="create table users(name varchar(100),email varchar(100)primary key,MobileNo bigint,securityQuestion varchar(200),Answer varchar(200),password varchar(100), address varchar(500),state varchar(100),city varchar(100),country varchar(100)  )";
